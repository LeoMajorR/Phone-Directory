...
/*
This Program Performs Phone Directory Management. 
This Primarily takes Name, Contact Number and a little information/alias about that Number and Stores it in File.
Major operations available are 

@ Add Contacts To Directory
@ Search Contact in Directory
@ Modify Contact in Directory
@ Delete Contact in Directory

and for Convinence I have added a View feature to have a glance at all contacts
...
// Below Structure is Primarily used for Storing Variable No of Contact Numbers 
...
//Takes Contact Name Number and Alias as Input and saves it to file
...
void Add_Contact()
{
    ...
    struct Contact add; //Structure to Add Contact
    ...
    add.numbers = (struct Numbers*) malloc(n*sizeof(struct Numbers)); // Allocating Memory for Numbers
...
void View_Directory()
{
    ...
    struct Contact display; //Structure to Display Information
...
// Strateg is to compare user inputed value to all th names available in file and when it matches 
// Print it's corresponding values  
...
// Strategy in Deletion is to copy information which usner don't want to delete to separate file and then 
// rename that file to name of orignal file

void Delete_Contact()
{
    FILE *ptr,*newrec; // Two pointer for temporarily saving information and transferring it to other file
    int choice;
